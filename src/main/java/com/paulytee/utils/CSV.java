...
//    static final private char SQUOTE = '\'';
    ...
    private static Reader stripBom(InputStream in) throws IOException, UnsupportedEncodingException
    {
        ...
        while ( (value = in.read()) != -1 ) {
            ...
            switch(c) {
                ...
                case LFEED:
                    ...
                    return stripMultipleNewlines && discardLinefeed(in, stripMultipleNewlines);
                ...
                case DQUOTE: {
                    ...
                    if (value == -1) {
                        // We ignore this error, and just add whatever left as the next field.
                        if (sbuf.length() > 0) {
                            fields.add(sbuf.toString());
                            sbuf.delete(0, sbuf.length());
                        }
                ...
                default:
                    if (c == separator) {
                        ...
                        if (c == COMMENT && fields.isEmpty() && StringUtils.isEmpty(s)) {
